    ...
    <section id="home" className={styles.homeMainContainer}>
      ...
      <div className={styles.homeContent}>
        <div className={styles.textSection}>
          ...
          <p>Choose repayment plans that work for you. We offer competitive rates and clear terms with no hidden fees.</p>
          <h3>Ready to Get Started?</h3>
          <p>Apply now and take the first step toward achieving your financial goals.</p>
